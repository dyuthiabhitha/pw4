...
path="C:/Users/dyuth/Downloads/speech-emotion-recognition-ravdess-data"
os.listdir(path)
...
dirName = 'C:/Users/dyuth/Downloads/speech-emotion-recognition-ravdess-data'
...
#Next Step is In-Depth Visualisation of Audio Fields and its certain features to plot for.
...
from scipy.io import wavfile
import glob,pickle
for file in tqdm(glob.glob(r"C:/Users/dyuth/speech-emotion-recognition-ravdess-data//**//*.wav")):
    file_name = os.path.basename(file)
    signal , rate = librosa.load(file, sr=16000)
    mask = envelope(signal,rate, 0.0005)
    wavfile.write(filename= r"C:/Users/dyuth/clean_speech"+str(file_name), rate=rate,data=signal[mask])
...
def load_data(test_size=0.33):
    answer = 0
    for file in glob.glob(r'C:\Users\dyuth\clean_speech\*.wav'):
        file_name=os.path.basename(file)
...
# data = np.array(data)
ans =[]
new_feature ,labels  = extract_feature(filearray, mfcc=True, chroma=True, mel=True)
